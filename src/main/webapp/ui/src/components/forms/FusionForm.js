...
export default class FusionForm extends Component {
    constructor(props){
        super(props);
        this.state = {
            cardType: "",
            ...
            <div className="contentWrapper">
                ...
                <div className="formElement" style={{width: "650px"}}> 
                    <div>
                        ...
                        <select id="abilitySelect" className="cardInfoSelect" defaultValue="Fusion" disabled>
                ...
                <div className="formElement" style={{width: "600px"}}>
                    <div>
                        <input type="image" id="addMaterialBtn" src={AddIcon} height="25px" width="25px" onClick={this.updateMaterials}/>
                        <input type="text" className="basicInput" id="newMaterialInput" style={{width: "250px", marginLeft: "10px", marginRight: "25px"}}/>
